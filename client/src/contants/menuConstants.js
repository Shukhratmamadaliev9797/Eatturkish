...
export const MENU_CATEGORIES_LIST_REQUEST = "MENU_CATEGORIES_LIST_REQUEST";
export const MENU_CATEGORIES_LIST_SUCCESS = "MENU_CATEGORIES_LIST_SUCCESS";
export const MENU_CATEGORIES_LIST_FAIL = "MENU_CATEGORIES_LIST_FAIL";

export const MENU_POPULAR_LIST_REQUEST = "MENU_POPULAR_LIST_REQUEST";
export const MENU_POPULAR_LIST_SUCCESS = "MENU_POPULAR_LIST_SUCCESS";
export const MENU_POPULAR_LIST_FAIL = "MENU_POPULAR_LIST_FAIL";
